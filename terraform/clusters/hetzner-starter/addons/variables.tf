...
variable "state_endpoint" {
  description = "S3 endpoint for the Terraform state bucket (e.g. https://fsn1.your-objectstorage.com for Hetzner)."
  type        = string
}
...
variable "longhorn_replica_count" {
  description = "Number of Longhorn replicas for the fast-rwo storage class. Must not exceed storage node count."
  type        = string
  default     = "1"
}
